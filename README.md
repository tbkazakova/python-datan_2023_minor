...
Курс для философа, филолога и Камиллы по питону и анализу данных
...
|---|---|---|---|
|09.09|Вводный семинар. Python. Арифметика и типы данных| [тетрадка]()|[задание]() + [опрос](https://forms.gle/UbNtY9HHbRBaSz9KA)|
